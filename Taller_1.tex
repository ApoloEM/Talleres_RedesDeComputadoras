...
\newcommand{\unidadNumero}{Unidad \#}
\newcommand{\semanaNumero}{Semana \#}
\newcommand{\codigoActividad}{TS\#De_La_Semana} % Taller Semana 1
...
\begin{document}
    ...
    \begin{titlepage}
        \begin{center}
            ...
            \Huge \tituloTaller\\
            \vspace{0.5cm}
            \large \unidadNumero \ - Taller \semanaNumero \\
            ...
            Rodriguez Maldonado Irving Alejandro 1182794\\
