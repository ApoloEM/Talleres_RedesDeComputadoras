...
\usepackage{array}     % Para columnas personalizadas
...
%==================================================================
% CONFIGURACIÓN DE LISTINGS PARA NETWORKING
%==================================================================
...
% Estilo para archivos de configuración
...
% Estilo para salida de terminal (sin resaltado)
...
% Configuración por defecto (Bash)
\lstset{style=bashStyle}

%==================================================================
% COMANDOS PERSONALIZADOS PARA REDES
%==================================================================

% Comando para direcciones IP
\newcommand{\ip}[1]{\texttt{\textcolor{ipcolor}{#1}}}

% Comando para protocolos
\newcommand{\proto}[1]{\texttt{\textbf{\textcolor{protocolor}{#1}}}}

% Comando para puertos
\newcommand{\port}[1]{\texttt{\textcolor{portcolor}{#1}}}

% Comando para comandos de red en línea
\newcommand{\cmd}[1]{\texttt{\textbf{#1}}}

% Comando para interfaces de red
...
% Configuración de títulos con color VerdeMilitar solo en section
\titleformat{\section}
...
% Tabla mejorada de seguridad en capas
\begin{table}[H]
    \centering
    \caption{Estructura de seguridad en capas en un centro de datos.}
    \label{tab:seguridad_capas}
    \begin{tabular}{@{}lp{10cm}@{}}
        \toprule
        \textbf{Capa de Seguridad} & \textbf{Descripción} \\
        \midrule
        Perímetro & Vallas, vigilancia física y control de accesos externos. \\
        Acceso al edificio & Controles de identidad y sistemas biométricos. \\
        Áreas internas & Segmentación de zonas y acceso restringido. \\
        Piso de datos & Acceso exclusivo a personal técnico autorizado. \\
        Destrucción de medios & Eliminación física segura de dispositivos de almacenamiento. \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lp{10cm}@{}}
        \toprule
        \textbf{Capa de Seguridad} & \textbf{Estándar Asociado} \\
        \midrule
        Perímetro & ISO/IEC 22237, ANSI/TIA-942 \\
        Acceso al edificio & ISO/IEC 27001 \\
        Áreas internas & Uptime Institute Tier Standard \\
        Piso de datos & ISO/IEC 27001 \\
        Protección contra incendios & NFPA 75 / NFPA 76 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.9\textwidth]{ejemplos_de_servicios en la nube.png}}
